...
WORKDIR /app
LABEL org.opencontainers.image.source="https://github.com/Opus-Perpetuus/imperium-subject-rh"
LABEL org.opencontainers.image.url="https://github.com/Opus-Perpetuus/imperium-subject-rh"
...
COPY src ./src
ENV PORT=3000 \
    SUBJECT_TECHNICAL_ID=subject-rh \
    KIRLET_TECHNICAL_ID=subject-rh \
    DATA_DIR=/data \
    SUBJECT_AUTH=on \
    KIRLET_AUTH=on
